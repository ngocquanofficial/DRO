...
# Run Python script
python main.py fit --config configs/dro_nodiv/dmlab.yaml

python main.py fit --config configs/dro_nodiv/kitti.yaml

python main.py fit --config configs/dro_nodiv/dsprites_loc.yaml

python main.py fit --config configs/dro_nodiv/dsprites_ori.yaml

python main.py fit --config configs/dro_nodiv/smallnorb_azi.yaml

python main.py fit --config configs/dro_nodiv/smallnorb_ele.yaml
