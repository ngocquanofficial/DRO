...
# Run Python script
python main.py fit --config configs/dro/patch_camelyon.yaml

python main.py fit --config configs/dro/eurosat.yaml

python main.py fit --config configs/dro/resisc45.yaml

python main.py fit --config configs/dro/retinopathy.yaml

python main.py fit --config configs/dro/clevr_count.yaml

python main.py fit --config configs/dro/clevr_dist.yaml
