...
python main.py fit --config configs/dro/caltech101.yaml

python main.py fit --config configs/dro/dtd.yaml

python main.py fit --config configs/dro/flower.yaml

python main.py fit --config configs/dro/pets.yaml

python main.py fit --config configs/dro/svhn.yaml

python main.py fit --config configs/dro/sun397.yaml
